...
from app.utils.rag_functions import get_list_openai_models, get_compiled_rag

with gr.Blocks(title="Compiled query") as compiled:
    chatbot = gr.Chatbot(label="Compiled query", show_copy_button=True)
